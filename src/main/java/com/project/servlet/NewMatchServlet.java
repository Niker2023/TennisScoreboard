...
public class NewMatchServlet extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            request.setAttribute("error", true);
            request.setAttribute("error_message", "Имя первого игрока уже существует! Введите другое.");
            request.getRequestDispatcher("/WEB-INF/new-match.jsp")
                    .forward(request, response);
            return;
        }
        try {
            ...
            request.setAttribute("error", true);
            request.setAttribute("error_message", "Имя второго игрока уже существует! Введите другое.");
            request.getRequestDispatcher("/WEB-INF/new-match.jsp")
                    .forward(request, response);
            return;
        }
